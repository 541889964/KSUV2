...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        androidx.compose.runtime.LaunchedEffect(Unit) {
            me.weishu.kernelsu.ui.xy.XyPrefs.load(this@MainActivity)
        }
        androidx.compose.foundation.layout.Box(modifier=androidx.compose.ui.Modifier.fillMaxSize()){
            me.weishu.kernelsu.ui.xy.XyWallpaperLayer()
            me.weishu.kernelsu.ui.xy.XyStealthGate {
            ...
            me.weishu.kernelsu.ui.xy.XyParticleLayer(me.weishu.kernelsu.ui.xy.XyPrefs.config.particle)
        }
}
    }
